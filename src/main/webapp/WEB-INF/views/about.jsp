		...
		<div class="container">
			...
			<div class="col-md-12">
				...
				<p class="push10">Reign in wild is a survival simulation game
					...
					island, set traps to protect from enemies.</p>
				<h1 class="h1head">The world</h1>
				<p class="push10">Description here</p>

				<h1 class="h1head">AI</h1>
				<p class="push10">Description here</p>

				<h1 class="h1head">Building</h1>
				<p class="push10">Description here</p>

				<h1 class="h1head">Craft system</h1>
				<p class="push10">Description here</p>

				<h1 class="h1head">Traps</h1>
				<p class="push10">Description here</p>
