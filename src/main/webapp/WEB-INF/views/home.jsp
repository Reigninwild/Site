...
<!-- ################################################################################################ -->
  <div class="wrapper"> 
    ...
    <li class="slide-container">
		<div class="slide">
			<img src="${pageContext.request.contextPath}/resources/images/poster.png" />
        </div>
		<div class="nav">
    ...
    <li class="slide-container">
        <div class="slide">
      	<img src="${pageContext.request.contextPath}/resources/images/screenshots/screen1.png" />
        </div>
		<div class="nav">
...
<!-- ################################################################################################ -->
  ...
  <div class="center push80">
      <h1 class="shout">Reign in wild: open world survival simulator for iOS and Android</h1>
      <p class="push10">Reign in wild is a survival simulation game with auto generated open world.
      You are an ordinary man who survived an airplane crash and found himself on a deserted tropical island.
         All you have to do is fight for life in the wild. Hunt animals, build shelters, fight with malevolent owners of the island. Using a huge amount of resources, you can craft weapons, buildings, traps and much more, that can help you survive.</p>
 <a href="${pageContext.request.contextPath}/about"><div class="learn_more2">Read more</div></a>
...
<div class="wrapper row4">
  <footer id="footer" class="clear"> 
    ...
    <div class="one_third">
      ...
      <p>Leave us your email address if you would like to be on the mailing list for news and updates</p>
      <form action="#" method="post">
        <label for="nlt_email">Mail <span>*</span></label><label id="email_error">invalid emeail</label>
